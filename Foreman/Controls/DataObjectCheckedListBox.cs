...
namespace Foreman.Controls {
	...
	public partial class DataObjectCheckedListBox : CheckedListBox {
		...
		protected override void OnDrawItem(DrawItemEventArgs e) {
			...
			e.DrawBackground();
			bool isChecked = e.Index >= Items.Count || GetItemChecked(e.Index);
			string text = e.Index < Items.Count ? ((IDataObjectBase)Items[e.Index]).FriendlyName : Name;
			...
			Font myFont = e.Font ?? SystemFonts.DefaultFont;
