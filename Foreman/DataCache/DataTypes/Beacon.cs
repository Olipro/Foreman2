...
namespace Foreman.DataCache.DataTypes {
	...
	internal class BeaconPrototype : EntityObjectBasePrototype, IBeacon {
		...
		public BeaconPrototype(DCache dCache, string name, string friendlyName, EnergySource source, bool isMissing = false) : base(dCache, name, friendlyName, EntityType.Beacon, source, isMissing) {
